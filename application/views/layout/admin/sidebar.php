        ...
        <?php if ($akses == 1 | $akses == 4 ) { ?>
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url('datapasien/laporanMedis');?>"><i class="fa fa-circle-o"></i> Laporan Individu Pasien</a></li>
              <li><a href="<?php echo base_url('kasir/keuangan');?>"><i class="fa fa-circle-o"></i> Laporan Keuangan</a></li>
            </ul>
          </li>
        <?php } ?>
        <?php if ($akses == 1 ) { ?>
